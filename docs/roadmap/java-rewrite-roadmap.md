...
| R6 | 渠道与控制面 | R6.1、R6.2 已合入；R6.3、R6.4 已远程验证 | 版本化 Message Runtime、本地 CLI、Provider Streaming、Telegram Channel 与可靠投递已离线验收；R6.4 Review/合并、真实 Smoke 和 Dashboard 仍待后续步骤 |
...
- R6.4 独立 Java SQLite 渠道账本、Inbox/Claim、事务 Outbox、`UNKNOWN`、容量门禁与回退演练已通过本地及 PR #7 远程离线门禁，Review/合并待执行。
...
- R6.4 持久 Inbox/Outbox、Receipt、恢复和回退已通过本地及 PR #7 远程离线门禁；不承诺自动重放或 Exactly Once，Review/合并与真实 Smoke 仍是独立门禁。
