...
| Proactive | `agent/core/proactive_*`、`bootstrap/proactive.py` | R8 Proactive Gate/NoOp Planner；R14-P0 Fixture/Kernel 边界 | 部分 | 默认 NoOp Delivery；R14-P0 已固定状态/租约、`FIXED_LOCAL` Source 净化与待审批投影，但未接线；外部源、真实推送、审批、自动 Memory 与网络仍按 [R14 计划](../plans/2026-07-19-r14-proactive-peer-memory-automation-plan.md)逐项推进 | 极高 |
