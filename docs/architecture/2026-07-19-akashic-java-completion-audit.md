...
- Java 证据基线：`agent/r12-skill-catalog`（R11-B3 只读 Workspace Tool 切片）
- 审计日期：2026-07-19
...
4. R12-S2 的目录发现和 R12-S3 API v2 只读生命周期 Tap 均已完成并通过三套门禁；R13 多渠道/控制面、R14 主动/
   Peer/自动记忆、R15 生产切换严格按顺序。
