...
| 主动运行与交付 | 受限 Scheduler/Drift/Subagent、只读主动决策、P2 本地候选与 Fake Pending/Recovery、sandbox 切换演练 | 外部源、自动 Memory、Peer、真实生产迁移 | P2 只完成未接线的 Fake 链：独立 Approval/Anchor/AES-GCM Capsule 与单次 Fake Port，没有 SQLite、网络或真实投递；先冻结每一类外部输入/副作用 Contract，再考虑接线 |
