...
| R12 | Skills、MCP 扩展与 Plugin 能力 | `agent/skills.py`、`agent/mcp/*`、`agent/plugins/*` | 受信 Skill Catalog/执行边界、MCP Resources/Prompts/Streamable HTTP、Plugin 生命周期兼容 | R12-S1 Skill Catalog 与 S2 MCP Assets 目录均已实现并通过三套门禁；按需正文/执行、远程 MCP 与 Plugin 生命周期仍未开始 |
