...
- 状态：已批准；R6.1–R6.4 已合入 `main`，R6.5 后端 G0–G10 与本地 Review 修复已通过阶段门禁，Draft PR #9 等待推送/Ready 授权
- 日期：2026-07-15
- 阶段：R6
...
| R6.5 | Dashboard 与最小控制面 | 后端 G0–G10 与本地 Review 修复已通过阶段门禁；PR #9 待推送和 Ready 授权 | 默认关闭的 Loopback 安全状态、SSE 和活动 Telegram Turn 取消；前端待 G11 批准 |
