...
用户已选择 Python 已有且代表性明确的 Telegram。JDK HTTP 长轮询、数值身份、网络、Token、Secret 和数据范围仍须按 [Telegram Channel Host 契约](../contracts/telegram-channel-host.md)、[设计](../specs/2026-07-16-telegram-channel-host-design.md)、[ADR-0009](../adr/0009-use-jdk-httpclient-for-telegram-long-polling.md)和[实施计划](2026-07-16-telegram-channel-host-implementation.md)单独批准。R6.3 默认先使用 Fake Server 和固定脱敏样本，真实 Smoke 后置。
