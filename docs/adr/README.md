...
- [ADR-0034：仅暴露活动且 hash-safe 的本地 Proactive Job 检视](0034-expose-only-active-hash-safe-proactive-job-inspection.md)
- [ADR-0035：以当前 Scope 的软失效实现获批的 Memory Forget](0035-use-scope-bound-soft-supersede-for-memory-forget.md)
- [ADR-0036：将控制面历史限制为内存终态元数据目录](0036-restrict-control-history-to-in-memory-terminal-metadata.md)
- [ADR-0037：将当前 Scope 历史详情限制为零正文元数据](0037-expose-current-scope-history-as-zero-content-metadata.md)
- [ADR-0038：选择 Scope 受限 Memory Forget 作为 R13-C3 的首项写 Capability](0038-select-scope-bound-memory-forget-as-first-r13-c3-write-capability.md)
- [ADR-0039：C3-M0 不新增直接 Memory Forget 管理入口](0039-keep-c3-memory-forget-creation-behind-approved-tool-producer.md)
- [ADR-0040：R14-P2 先局限为本地候选与 Fake Delivery Preparation](0040-restrict-r14-p2-to-local-candidate-and-fake-delivery-preparation.md)
- [ADR-0041：将 R14-P3 至 P5 限制为获批的本地 Fake Capability](0041-restrict-r14-p3-p5-to-approved-local-fakes.md)
- [ADR-0042：将 R14-P6 限制为临时 SQLite 的获批 NOTE 写入演练](0042-restrict-r14-p6-to-temp-sqlite-note-rehearsal.md)
