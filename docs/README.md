...
- 已完成首个副作用 Capability 候选审计：[R11-B2c 选择记录](plans/2026-07-19-r11-first-side-effect-capability-selection.md)推荐只删除当前 Java Session 内单个已知 Memory ID 的 `forget_memory`，但它仍是数据删除；在逐 Tool 明确批准前，生产继续 Deny All、无 Recovery 路由且不注册该 Tool。
