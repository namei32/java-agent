...
- 下一里程碑：冻结核心消息、生命周期和 Tool Contract，再实现最小 Tool Loop；不能直接跳到工具生态扩展。
...
当前 Golden 资产从 [Python/Java Golden Test 夹具规范](contracts/golden-test-fixtures.md)进入，包含配置、历史、Prompt、SQLite 和错误映射基准。
