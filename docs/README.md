...
- 实施中：R4.2 Java 原生方案已于 2026-07-15 获批，Task J1 Contract Fixture 与 J2 Kernel Memory/Embedding 协议已完成，下一步进入 J3 Schema 与 Float32 Vector Codec；生产默认继续保持 `DISABLED`。
