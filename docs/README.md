...
- 已完成：R13-C2-B0 的[受限历史详情决策门禁](contracts/r13-c2-b-history-decision-gate.md)与[逐任务实施计划](plans/2026-07-19-r13-c2b-history-detail-implementation-plan.md)。它只固定后续授权问题、永久禁止字段、Fixture 分组、TDD 任务和阶段门禁；尚未读取任何 Session 数据或批准 C2-B 运行时。
