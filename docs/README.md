...
- 待批准：R4.2 已根据“旧 Python 记忆不迁移”的决定改写为 Java 原生方案，包含 `agent-memory.db`、显式记忆管理 API、Embedding、语义检索和 Optimizer 安全 Contract；批准前不修改生产代码。
